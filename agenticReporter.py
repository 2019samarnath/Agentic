...
claude_3_5_sonnet = ChatAnthropic(model="claude-3-5-haiku-latest", temperature=0)
...
async def generate_report_plan(state: ReportState, config: RunnableConfig):
    ...
    source_str = deduplicate_and_format_sources(search_docs, max_tokens_per_source=500, include_raw_content=False)
...
def write_section(state: SectionState):
    ...
    # Generate section
    section_content = claude_3_5_sonnet.invoke([SystemMessage(content=system_instructions)] + [
...
if __name__ == "__main__":
    async def main():
        ...
        try:
            ...
            config_dict = vars(config)  # Use vars() to get the dictionary representation of the object
